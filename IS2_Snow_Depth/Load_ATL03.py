...
def get_ATL03(f,beam):
    ...
    """
    sc_orient = np.asarray(f["orbit_info"]["sc_orient"])
    print('sc_orient', sc_orient)
    if sc_orient == 1:
        weak_beam = ['gt1l','gt2l','gt3l']
        strong_beam = ['gt1r','gt2r','gt3r']
    if sc_orient == 0:
        strong_beam = ['gt1l','gt2l','gt3l']
        weak_beam = ['gt1r','gt2r','gt3r']
    ...
    if beam in weak_beam:
        beaminfo = 'weak beam'
    else: 
        beaminfo = 'strong beam'
